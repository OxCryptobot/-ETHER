...
Assume the system works and underperforms. Expose why. Do not defend implementations.

## Grounding (mandatory)

Read GitHub OxCryptobot/-ETHER, not memory of a prior chat.
...
2026-08-29 baseline: 4 / 6 / 8 / 3 / 3 / 5 / 6 / 5 / 2 / 2. Overall product ~4.4. Harness honesty ~7.

## Output

Write docs/AUDIT_SOTA_<date>.md. Update goal plus keep-pushing if doctrine moved. Do not lift wheels from the audit.

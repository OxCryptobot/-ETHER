...
READ = frozenset({"list_files", "read_file", "grep", "glob", "git_diff", "git_status"})
WRITE = frozenset({"write_file", "apply_patch", "rollback", "rename", "delete"})
VERIFY = frozenset({"run_tests", "pep8_review", "done"})
